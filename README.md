...
### test-mailpit
Test SMTP relay service using Mailpit as upstream. Emails are captured and viewable at [mail.staging.svcmarket.com](https://mail.staging.svcmarket.com). No actual delivery occurs.
